...
int countIncludes(const string a1[], int n1, const string a2[], int n2)
{
    ...
    if (a1[0] == a2[0])
    {
        int countinclu = countIncludes(a1+1, n1 - 1, a2+1, n2 - 1); //count current string
        int startpoint = countIncludes(a1+1, n1 - 1, a2, n2); //string start from the next index
        return countinclu + startpoint;
    }
